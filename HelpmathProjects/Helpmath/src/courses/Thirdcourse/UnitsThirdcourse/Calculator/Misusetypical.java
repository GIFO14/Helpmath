package courses.Thirdcourse.UnitsThirdcourse.Calculator;
    ...
    public void actionPerformed(ActionEvent eMisusetypical) {
        if (eMisusetypical.getSource() == accept) {
            ...
            try {
                ...
                //(5-14)^22*78,89+(61-12)^4*22+(2-44)^3*22
                ...
                if (showresult.getText().equals(" Resultat: NaN")){
                    
                    JOptionPane.showMessageDialog(null, "No s'ha pogut obtenir un resultat de la operació entrada. El motiu és el següent: Decimals a la potència.");
